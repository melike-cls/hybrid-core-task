...
const PartnerList = [
  ...
  {
    name: "Chatham House",
    description: "The Jagiellonian University (JU) is the oldest higher education institution in Poland and one of the oldest in Europe. It was founded on 12 May 1364 by the Polish king Casimir the Great. The Jubilee year 2014 marked the 650th anniversary of this remarkable event. ",
...
const PartnersSection = () => {
  return (
    ...
    {PartnerList.map((partner, index) => (
      <Grid container key={partner.name} spacing={2} direction={index % 2 === 0 ? 'row' : 'row-reverse'}>
        <Grid item xs={12} md={6}>
          ...
          >
            <Image src={partner.logo} alt={partner.name} layout="responsive" width={200} height={75} />
          </Box>
        </Grid>
        <Grid item xs={12} md={6}>
          <Box sx={{ m: 30 }}>
